...
<div class="card overflow-hidden hover:shadow-lg transition-shadow duration-200">
    ...
    {{-- Action Buttons --}}
    <div class="px-5 py-3 space-y-2" style="border-top: 1px solid var(--border-color);">
        <a href="{{ route('referee.referee-trip-detail', $trip->id) }}"
           class="w-full btn-secondary text-sm inline-flex items-center justify-center gap-2">
